...
public class PatientOpdVitalsAdapter extends RecyclerView.Adapter<PatientOpdVitalsAdapter.MyViewHolder> {
    ...
    public PatientOpdVitalsAdapter(FragmentActivity activity, ArrayList<String> namelist,

...
public class PatientOpdTimelineAdapter extends RecyclerView.Adapter<PatientOpdTimelineAdapter.MyViewHolder> {
    ...
    public PatientOpdTimelineAdapter(FragmentActivity activity, ArrayList<String> titlelist,
                                     ArrayList<String> timeline_dateList, ArrayList<String> descriptionList, ArrayList<String> idlist, ArrayList<String> documentlist) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView downloadBtn,deleteBtn,editBtn;
        View lineView;
        LinearLayout layout;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_patient_opd_timeline, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.dateTV.setText(Utility.parseDate("yyyy-MM-dd hh:mm:ss", defaultDateFormat,timeline_dateList.get(position)));

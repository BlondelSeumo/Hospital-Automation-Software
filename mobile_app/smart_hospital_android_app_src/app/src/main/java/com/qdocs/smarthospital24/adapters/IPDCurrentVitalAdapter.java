...
public class IPDCurrentVitalAdapter extends RecyclerView.Adapter<IPDCurrentVitalAdapter.MyViewHolder> {
    ...
    public IPDCurrentVitalAdapter(Context applicationContext, ArrayList<String> idlist, ArrayList<String> currentvitallist, ArrayList<String> reference_rangelist,
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.currentvitalipd, parent, false);

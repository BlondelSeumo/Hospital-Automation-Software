...
public class PatientOpdVisitPaymentAdapter extends RecyclerView.Adapter<PatientOpdVisitPaymentAdapter.MyViewHolder> {
    ...
    public PatientOpdVisitPaymentAdapter(FragmentActivity fragmentActivity, ArrayList<String> payment_modeList, ArrayList<String> dateList,
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView note,date,paymentmode,paidamount,chequedate,chequeno,transactionid;

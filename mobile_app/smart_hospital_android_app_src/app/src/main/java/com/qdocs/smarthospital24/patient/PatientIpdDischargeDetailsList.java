...
public class PatientIpdDischargeDetailsList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(gender.equals("Female")) {
            ...
            viewPagerAdapter.addFragment(new PatientIPDVitalsFragment(ipdnos), getApplicationContext().getString(R.string.vitals), tabIcons[12]);
            viewPagerAdapter.addFragment(new PatientIPDObstericHistoryFragment(ipdnos), getApplicationContext().getString(R.string.prev_obs_history), tabIcons[13]);
            viewPagerAdapter.addFragment(new PatientIPDPostnatalHistoryFragment(ipdnos), getApplicationContext().getString(R.string.post_history), tabIcons[14]);
            viewPagerAdapter.addFragment(new PatientIPDAntenatalHistoryFragment(ipdnos), getApplicationContext().getString(R.string.antenatal), tabIcons[15]);
        }else{
            viewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager(), this);

                ...
                <div class="paybox_bg"> 
                    <h3 class="bt_title"><img src="<?php echo base_url('backend/images/mollie.png');?>" style="margin-bottom: 10px;"><br />Mollie Payment Gateway</h3>  
                      <?php if($error){
                        ...
                        <div class="paybody">
                            <form class="paddtlrb" action="<?php echo site_url('gateway/mollie/pay') ?>" method="POST" id="paypalForm">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="amount" readonly value="<?php echo number_format($amount,2,'.',''); ?>" />
                                    </div>
                                </div><!--./form-group-->

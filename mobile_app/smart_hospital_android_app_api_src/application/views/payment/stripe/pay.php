				...
				<div class="dropin-page">
					...
					<div class="alert-danger"> <?php echo form_error('name'); ?></div>
				 	 ...
				 	 <label class="col-sm-4">Amount (<?php echo $session_params['invoice']->symbol;?>)</label>
				 		<div class="col-sm-8"><input class="form-control"  name="amount" value="<?php echo set_value('total', number_format((float)($amount), 2, '.', '')) ?>"/>
				 		<!-- <div class="form-control"><?php echo $session_params['total'];?></div> -->
...
<form id="stripe-payment-form" class="paddtlrb" action="<?php echo site_url('gateway/stripe/complete'); ?>" method="POST">
    ...
    <input type="hidden" name="total" id="amount" value="<?php echo number_format((float)($amount), 2, '.', ''); ?>">
            ...
            <div class="button-between footer">

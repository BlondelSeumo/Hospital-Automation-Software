...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="paybox">   
			    <div class="paybox_bg"> 
			        <h3 class="bt_title"><img src="<?php echo base_url('backend/images/sslcommerz.png');?>" style="margin-bottom: 10px;"><br />Sslcommerz Payment Gateway</h3>  
			          <?php if($api_error){
                                ?>
                        ...
                        <div class="paybody">
                                ...
                                <form class="paddtlrb" action="<?php echo site_url('gateway/sslcommerz/pay') ?>" method="POST" id="paypalForm">

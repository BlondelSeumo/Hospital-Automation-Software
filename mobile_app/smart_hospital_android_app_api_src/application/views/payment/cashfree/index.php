                ...
                <div class="paybox_bg"> 
                    <h3 class="bt_title"><img src="<?php echo base_url('backend/images/cashfree.png');?>" style="margin-bottom: 10px;"><br />Cashfree Payment Gateway</h3>  
                      <?php if($api_error){
                        ...
                        <div class="paybody">
                            <form class="paddtlrb" action="<?php echo site_url('gateway/cashfree/pay') ?>" method="POST">
                                ...
                                <div class="form-group row">
                                 <label class="col-sm-4">Amount(<?php echo $session_params['invoice']->symbol;?>)</label>
                                  <div class="col-sm-8"><input class="form-control" name="amount" value="<?php echo number_format((float)($amount), 2, '.', ''); ?>" /></div>
                                </div><!--./form-group-->

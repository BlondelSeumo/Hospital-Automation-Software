			        ...
			        <h3 class="bt_title"><img src="<?php echo base_url('backend/images/billplz.jpg');?>" style="margin-bottom: 10px;"><br />Billplz Payment Gateway</h3>  
			          <?php if($api_error){
                        ...
                        <div class="paybody">
                                ...
                                <form class="paddtlrb" action="<?php echo site_url('gateway/billplz/pay') ?>" method="POST" id="paypalForm">
									  ...
									  <div class="col-sm-8">
										...
										<div class="form-group row">
										 <label class="col-sm-4">Amount(<?php echo $session_params['invoice']->symbol;?>)</label>
										  <div class="col-sm-8"><input class="form-control" name="amount" value="<?php echo set_value('amount', number_format((float)($session_params['total'], 2, '.', '')) ?>"/></div>

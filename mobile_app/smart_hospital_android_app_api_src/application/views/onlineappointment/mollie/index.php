...
<title>Mollie Custom Integration</title>
                ...
                <div class="paybox_bg"> 
                    <h3 class="bt_title"><img src="<?php echo base_url('backend/images/mollie.png');?>" style="margin-bottom: 10px;"><br />Mollie Payment Gateway</h3>  
                      <?php if($api_error){
                        ...
                        <div class="paybody">
                            <form class="paddtlrb" action="<?php echo site_url('onlineappointment/mollie/pay') ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control"  name="email" value="<?php echo set_value('email', $session_params['email']) ?>"/>
                                    </div>
                                </div><!--./form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="amount" disabled="disabled" value="<?php echo set_value('amount', number_format((float)($this->session->userdata('payment_amount')), 2, '.', '')) ?>" readonly/>
                                    </div>
                                </div><!--./form-group-->

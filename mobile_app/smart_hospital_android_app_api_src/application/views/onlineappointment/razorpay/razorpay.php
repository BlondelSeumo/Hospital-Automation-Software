...
<title>Razorpay  Custom Integration</title>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="paybox">   
			    <div class="paybox_bg"> 
			        <h3 class="bt_title">Razorpay Payment Gateway</h3>                         
                        <div class="paybody">

                                <form class="paddtlrb" action="<?php echo base_url('onlineappointment/razorpay/pay') ?>" method="POST" id="paypalForm">
					...
					<div class="form-group row">
						<label class="col-sm-4">Email</label>
										 <div class="col-sm-8">
										 	<input class="form-control" readonly name="email" value="<?php echo set_value('email', $session_params['email']) ?>"/></div>
										</div><!--./form-group-->
										<div class="form-group row">
										<label class="col-sm-4">Phone</label>
										<div class="col-sm-8"><input class="form-control" readonly name="phone" value="<?php echo set_value('phone', $session_params['mobileno']) ?>"/></div>
										</div><!--./form-group-->
										<div class="form-group row">
										 <label class="col-sm-4">Amount(<?php echo $session_params['invoice']->symbol;?>)</label>
										  <div class="col-sm-8"><input class="form-control"  value="<?php echo set_value('amount', number_format((float)($this->session->userdata('payment_amount')), 2, '.', '')) ?>" readonly/></div>
										</div><!--./form-group-->

...
<title>Pesapal  Custom Integration</title>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="paybox">   
			    <div class="paybox_bg"> 
			        <h3 class="bt_title">Pesapal Payment Gateway</h3>  
			          <?php if($api_error){
                                ?>
                        ...
                        <div class="paybody">
                                ...
                                <form class="paddtlrb" action="<?php echo site_url('onlineappointment/pesapal') ?>" method="POST" id="paypalForm">

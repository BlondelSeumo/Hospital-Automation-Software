...
<title>Billplz  Custom Integration</title>
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="paybox">   
			    <div class="paybox_bg"> 
			        <h3 class="bt_title">Billplz Payment Gateway</h3>  
			          <?php if($api_error){
                                ?>
                        ...
                        <div class="paybody">
                                ...
                                <form class="paddtlrb" action="<?php echo site_url('onlineappointment/billplz/pay') ?>" method="POST" id="paypalForm">
									<div class="form-group row">
									  ...
									  <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                          					<button type="submit" id="pay-button" class="submit_button"><i class="fa fa-money"></i> Pay Now 
                          					</button> 
                          				</div>	

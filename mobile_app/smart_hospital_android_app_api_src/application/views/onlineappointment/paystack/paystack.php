...
<title>Paystack  Custom Integration</title>
			        ...
			        <h3 class="bt_title">Paystack Payment Gateway</h3>  
			          <?php if($api_error){
                        ...
                        <div class="paybody">
                                ...
                                <form class="paddtlrb" action="<?php echo site_url('onlineappointment/paystack/pay') ?>" method="POST" id="paypalForm">
									  ...
									  <div class="col-sm-8">
										...
										<div class="form-group row">
										 <label class="col-sm-4">Amount(<?php echo $session_params['invoice']->symbol;?>)</label>
										  <div class="col-sm-8"><input class="form-control" name="amount" disabled="disabled" value="<?php echo set_value('amount', number_format((float)($this->session->userdata('payment_amount')), 2, '.', '')) ?>" disabled /></div>
										</div><!--./form-group-->

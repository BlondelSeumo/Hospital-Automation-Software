...
class User_model extends CI_Model {
    ...
    public function checkLoginParent($data) {
     ...
     public function read_user_information($users_id) {
        $this->db->select('users.*,patients.patient_name,patients.id,patients.age,patients.month,patients.image,patients.mobileno,patients.email,patients.dob,patients.gender,patients.marital_status,patients.blood_group,patients.address,patients.guardian_name');
        $this->db->from('users');

...
class Flutterwave extends Admin_Controller {
	...
	{ 
        ...
        $data['setting'] = $this->setting;
        $this->load->view('onlineappointment/flutterwave/flutterwave', $data);
	}
    ...
    public function pay(){
        ...
        $data['setting'] = $this->setting;
            ...
            $payment_details=$this->session->userdata('params');
            $payment_details['post_amount']=$amount;
            ...
            $redirect_url = base_url() . 'onlineappointment/flutterwave/success'; // Set your own redirect URL
